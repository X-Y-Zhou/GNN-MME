...
## Load training set
VT = 121
ssa_path = "example/example3/data"
...
@load "example/example3/model_params/p_intra1.bson" p_intra1
...
@load "example/example3/model_params/p_intra2.bson" p_intra2
...
@load "example/example3/model_params/p_Minter.bson" p_Minter
...
@load "example/example3/model_params/p_Pinter.bson" p_Pinter
